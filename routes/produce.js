...
import { createProduce, getAllProduce, updateProduce, deleteProduce, getMyProduce, getSingleProduce } from "../controller/produce.js";
...
produceRouter.get("/produce", isAuthenticated, hasPermission("get_produce"), requireRole(["farmer", "buyer"]), getAllProduce);
...
produceRouter.get( "/produce/:id", isAuthenticated, hasPermission("get_produce"), requireRole(["buyer", "farmer"]), getSingleProduce);
